...
export default function Van_Detail () {
    ...
    function updateStyle () {
        if (targetVan.type === "simple") {
            setStyle({backgroundColor: targetVan.type == "simple" && "#E17654"})
        }
        else if (targetVan.type === "luxury") {
            setStyle({backgroundColor: targetVan.type == "luxury" && "#161616"})
        }
        else if (targetVan.type === "rugged") {
            setStyle({backgroundColor: targetVan.type == "rugged" && "#115E59"})
